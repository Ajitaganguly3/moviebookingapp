...
public class MoviesController {
	...
	@GetMapping("/all")
	public ResponseEntity<List<MoviesDTO>> getAllMovies(@RequestHeader("Authorization") String token, @RequestHeader("role") String role)throws InvalidTokenException, UnauthorizedException{
	...
	public ResponseEntity<?> searchMovies(@PathVariable String moviename, @RequestHeader("Authorization") String token, @RequestHeader("role") String role)throws InvalidTokenException, UnauthorizedException{
